...
var Remote = /** @class */ (function () {
    ...
    Remote.prototype.sendKey = function (key) {
    ...
    Remote.prototype.sendKeys = function () {
        var keys = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            keys[_i] = arguments[_i];
        }
        return __awaiter(this, void 0, void 0, function () {
            var conn, _a, keys_1, key;
    ...
    Remote.prototype.openConnection = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var rfbConnection = rfb2_1.default.createConnection({
                host: _this.box.ip,
                port: 5900,
                password: "",
            });
