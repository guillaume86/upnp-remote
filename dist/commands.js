...
function setChannelSafe(box, channel, maxTries, currentTry) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var err_1, lastTry, remote;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 7]);
                    // rejected with Error: TRANSPORT IS LOCKED (705) if in stand by
                    return [4 /*yield*/, voo_1.setChannel(box, channel)];
                case 1:
                    // rejected with Error: TRANSPORT IS LOCKED (705) if in stand by
                    _a.sent();
                    return [3 /*break*/, 7];
                case 2:
                    ...
                    if (!(!lastTry && err_1 instanceof Error && err_1.message === STANDBY_ERROR)) return [3 /*break*/, 5];
